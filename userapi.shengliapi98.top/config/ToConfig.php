...
return [
    ...
    'app_update' => [
        'image_url' => 'https://resourseapi.shengliapi98.top',//上传文件域名 图片视频等
        'app_qrcode' => 'https://resourseapi.shengliapi98.top/',//二维码地址
    ],
    'app_tg' => [
